...
**Notes**: If outputFile isn't entered, then inputFile will be modified in-place. If symbol cleanup type isn't entered, then it defaults to CSY (Central Siberian Yupik Latin orthography).<br>This program uses [this reference table](https://docs.google.com/spreadsheets/d/117vb5qA2RsJRwvItce6txtEqLVv1QTB_aa82CraC2Sg/edit?usp=sharing) by Grace Angivran Moore-Anderson, Levi Anderson, and Nalugalria Usugan-Weddington.<br>
