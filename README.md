...
All programs are written in Bash and need to be run in a Shell like Windows Powershell.<br>*fixFormatting.sh* and *transOrthography.sh* use [this reference table](https://docs.google.com/spreadsheets/d/117vb5qA2RsJRwvItce6txtEqLVv1QTB_aa82CraC2Sg/edit?usp=sharing) by Grace Angivran Moore-Anderson, Levi Anderson, and Nalugalria Usugan-Weddington.
...
**Notes**: If outputFile is not entered, then inputFile will be modified in-place.<br>
