...
CSYReplacements=("p" "t" "k" "kw" "q" "qw" "v" "l" "z" "y" "r" "g" "w" "gh" "ghw" "f" "ll" "s" "rr" "gg" "wh" "ghh" "ghhw" "h" "m" "n" "ng" "ngw" "mm" "nn" "ngng" "ngngw" "i" "u" "e" "a" "" "" "")
...
for langTag in "${abbrvNL[@]}"; do
	sed -i -E "s/\b($langTag)\b/\n\1/g" "$outputFile"; # Newline after each langTag
done
